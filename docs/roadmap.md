...
Статус: M1–M4 реализованы (2026-09-18), M5 — 2026-09-25, M6 частично (юнит-тесты есть,
интеграционный набор — нет). Цель — не тонкая обёртка над HTTP (голые массивы туда-обратно),

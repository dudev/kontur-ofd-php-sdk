...
1.	`auth.sid` с идентификатором пользовательской сессии, полученному по алгоритму в разделе :doc:`Authentication`. Вам нужно выбрать способ аутентификации, и мы настроим соответствующие права доступа.
2.	Ключ интегратора. 

Что нужно для получения ключа интегратора и настройки способа аутентификации, описано в разделе :doc:`GetAccess`.

...
- `dateFrom`: string, обязательный, дата и время, начиная с которой (включительно) необходимо получить документы.
- `dateTo`: string, обязательный, дата и время, по которую (включительно) необходимо получить документы.

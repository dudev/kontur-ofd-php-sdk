...
::
  ...
  "receipt": {                                                  //для бланка строгой отчетности - bso
    ...
    "nds22": 250,                                               //number, необязательный - сумма НДС чека по ставке 22%, в копейках
    ...
    "ndsCalculated22": 150,                                     //number, необязательный - сумма НДС чека по расч. ставке 22/122, в копейках
    ...
    "internetSignForMarking": 1,                                //number, необязательный - признак расчета в Интернет
  ...
  "items": [                                        //array of objects, необязательный - предметы расчета
    {
      ...
      "ndsCalculated22": 150,                       //number, необязательный - сумма НДС предмета расчета по расч. ставке 22/122, в копейках
      "ndsCalculated20": 130,                       //number, необязательный - сумма НДС предмета расчета по расч. ставке 20/120, в копейках
      "ndsCalculated18": 100,                       //number, необязательный - сумма НДС предмета расчета по расч. ставке 18/118, в копейках
      "ndsCalculated10": 120,                       //number, необязательный - сумма НДС предмета расчета по расч. ставке 10/110, в копейках
      "ndsCalculated7": 150,                        //number, необязательный - сумма НДС предмета расчета по расч. ставке 7/107, в копейках
      "ndsCalculated5": 130,                        //number, необязательный - сумма НДС предмета расчета по расч. ставке 5/105, в копейках
      
      "nds22": 250,                                 //number, необязательный - сумма НДС предмета расчета по ставке 22%, в копейках
      "nds20": 230,                                 //number, необязательный - сумма НДС предмета расчета по ставке 20%, в копейках
      "nds18": 100,                                 //number, необязательный - сумма НДС предмета расчета по ставке 18%, в копейках
      "nds10": 120,                                 //number, необязательный - сумма НДС предмета расчета по ставке 10%, в копейках
      "nds7": 150,                                  //number, необязательный - сумма НДС предмета расчета по ставке 7%, в копейках
      "nds5": 130,                                  //number, необязательный - сумма НДС предмета расчета по ставке 5%, в копейках
      "nds0": 140,                                  //number, необязательный - сумма расчета по предмету расчета с НДС по ставке 0%, в копейках
      "ndsNo": 0,                                   //number, необязательный - сумма расчета по предмету расчета без НДС, в копейках
      "ndsType": "nds22",                           //string, необязательный - ставка НДС по предмету расчета
...
Возможные значения поля "ставка НДС":
...
.. table::
  ...
  | nds10           | ставка НДС 10%                |
  +-----------------+-------------------------------+
  | ndsCalculated20 | ставка НДС расч. 20/120       |
  +-----------------+-------------------------------+
  | ndsCalculated18 | ставка НДС расч. 18/118       |
  +-----------------+-------------------------------+
  | ndsCalculated10 | ставка НДС расч. 10/110       |
  +-----------------+-------------------------------+
  | nds0            | ставка НДС 0%                 |
  +-----------------+-------------------------------+
  | ndsNo           | НДС не облагается             |
  +-----------------+-------------------------------+
  | nds5            | ставка НДС 5%                 |
  +-----------------+-------------------------------+
  | nds7            | ставка НДС 7%                 |
  +-----------------+-------------------------------+
  | ndsCalculated5  | ставка НДС расч. 5/105        |
  +-----------------+-------------------------------+
  | ndsCalculated7  | ставка НДС расч. 7/107        |
  +-----------------+-------------------------------+
  | nds22           | ставка НДС 22%                |
  +-----------------+-------------------------------+
  | ndsCalculated22 | ставка НДС расч. 22/122       |
  +-----------------+-------------------------------+
